...
print(remove_element([3,2,2,3], 3)) # 2, nums = [2,2,_,_]
print(remove_element([0,1,2,2,3,0,4,2], 2)) # 5, nums = [0,1,3,0,4,_,_,_]
print(remove_element([1], 1)) # 0, nums = [_]
print(remove_element([1,1,1], 1)) # 0, nums = [_,_,_]